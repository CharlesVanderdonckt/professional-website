...
export function blogImageUrl(fileName: string): string {
  return `${import.meta.env.BASE_URL}blog-images/${fileName}`;
}
...
export const blogPosts: BlogPost[] = [
  {
    ...
    images: [blogImageUrl("hack-the-future-2025.jpg")],
    links: [{ label: "Linkedin Post", url: "https://www.linkedin.com/posts/charles-vanderdonckt_hackthefuture-linux-ansible-activity-7394496224957091840-69lB?utm_source=share&utm_medium=member_desktop&rcm=ACoAADnWSj8BwJimouy6lIIxiInFFGHFqMbhErw"}]
  },
  {
    id: "podcast-episode-1",
    title: "Cyber Frontlines #1 - Jo Buysschaert",
    excerpt: "Podcast episode about cybersecurity, professional experience and learning from an external expert in the field.",
    content: "Podcast episode featuring guest Jo Buysschaert about cybersecurity, professional experience and learning from an external expert in the field.",
    tags: ["Podcast", "Cybersecurity"],
    images: [blogImageUrl("podcast-episode-1.jpg")],
    links: [{ label: "Listen on YouTube", url: "https://www.youtube.com/watch?v=bVxs7w6SZ7Q" }]
  },
  {
    ...
    images: [blogImageUrl("dotnet-10-preview.jpg") ],
    links: [{ label: "Linkedin Post", url: "https://www.linkedin.com/posts/charles-vanderdonckt_yesterday-18-november-i-attended-the-technology-activity-7396891475982278657-nzCD?utm_source=share&utm_medium=member_desktop&rcm=ACoAADnWSj8BwJimouy6lIIxiInFFGHFqMbhErw"}]
  },
  {
    id: "ipv6-standard",
    ...
    images: [blogImageUrl("ipv6-standard.jpg")],
    links: [{ label: "Linkedin Post", url: "https://www.linkedin.com/posts/charles-vanderdonckt_the-central-focus-of-last-weeks-tech-meet-activity-7401599804197416960-tcem?utm_source=share&utm_medium=member_desktop&rcm=ACoAADnWSj8BwJimouy6lIIxiInFFGHFqMbhErw" }]
  },
  {
    ...
    images: [blogImageUrl("threat-intelligence-ccb.jpg")],
    links: [{ label: "Linkedin Post", url: "https://www.linkedin.com/posts/charles-vanderdonckt_tech-meet-threat-intelligence-from-activity-7401607740131127296-_LiZ?utm_source=share&utm_medium=member_desktop&rcm=ACoAADnWSj8BwJimouy6lIIxiInFFGHFqMbhErw" }]
  },
  {
    ...
    images: [blogImageUrl("nato-cyber-defense.jpg")],
    links: [{ label: "Linkedin Post", url: "https://www.linkedin.com/posts/charles-vanderdonckt_this-week-i-attended-a-tech-meet-session-activity-7403604852078972928-6h7N?utm_source=share&utm_medium=member_desktop&rcm=ACoAADnWSj8BwJimouy6lIIxiInFFGHFqMbhErw"}]
  },
  {
    ...
    images: [blogImageUrl("belgium-cyber-defense.jpg")],
    links: [{ label: "Linkedin Post", url: "https://www.linkedin.com/posts/charles-vanderdonckt_cybersecurity-infosec-threatintelligence-activity-7410818086229970944--i_y?utm_source=share&utm_medium=member_desktop&rcm=ACoAADnWSj8BwJimouy6lIIxiInFFGHFqMbhErw"}]
  }
];
