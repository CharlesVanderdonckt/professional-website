...
export const blogPosts: BlogPost[] = [
  {
    ...
    images: [`${base}blog-images/hack-the-future-2025.jpg`]
  },
  {
    ...
    images: [`${base}blog-images/dotnet-10-preview.jpg`]
  },
  {
    id: "ipv6-standard",
    date: "2024-11-10",
    ...
    images: [`${base}blog-images/ipv6-standard.jpg`]
  },
  {
    ...
    images: [`${base}blog-images/threat-intelligence-ccb.jpg`]
  },
  {
    ...
    images: [`${base}blog-images/nato-cyber-defense.jpg`]
  },
  {
    ...
    images: [`${base}blog-images/belgium-cyber-defense.jpg`]
  }
];
